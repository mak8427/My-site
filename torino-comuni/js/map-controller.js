...
export class LeafletMapController {
    ...
    async load({ municipalityGeoJson, outlineGeoJson, municipalities, onActivate }) {
        ...
        this.setHoverText('Borders are visible. Names stay hidden until guessed.');
    }
    ...
    bindFeature(feature, layer) {
        ...
        layer.on('mouseover', () => {
            ...
            this.setHoverText(isFound ? this.metaIndex.get(code).officialName : 'Hidden municipality');
    ...
    getThemeColors() {
        return {
            ...
            boundary: readCssVar('--map-boundary', '#8d8372'),
            ...
            foundGlow: readCssVar('--found-glow', 'rgba(180, 83, 9, 0.22)')
        };
    }
